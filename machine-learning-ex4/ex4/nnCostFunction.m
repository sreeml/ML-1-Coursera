...
%z2 equals the product of a1 and Θ1, a1: 5000x401, Theta1, Delta1 and Theta1_grad: 25x401
z2 = a1 * Theta1';
...
%z3 equals the product of a2 and Θ2, a2: 5000x26, Theta2, Delta2 and Theta2_grad: 10x26
z3 = a2 * Theta2';
...
% use h, y_matrix, m =# of training examples
...
left = -y_matrix .* log(h); 
right = (1-y_matrix) .* log(1-h);
J1 = (1/m) * (sum(sum((left - right)))); 
...
%unregularized gradient from back propagation
d3 = a3 - y_matrix;

d2 = (d3 * Theta2(:,2:end)) .* sigmoidGradient(z2);

%(d2,d3 are 16x4, a1, a2 are 16x3)
Delta1 = d2' * a1;

Delta2 = d3' * a2;


unreg_grad1 = Delta1 .* (1/m);
unreg_grad2 = Delta2 .* (1/m);

%regularized gradient from back propagation
...
Theta1_grad = Delta1 .*(1/m) + penalty1;
Theta2_grad = Delta2 .*(1/m) + penalty2;
